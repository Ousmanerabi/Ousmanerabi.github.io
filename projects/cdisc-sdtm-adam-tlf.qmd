...
-   Create **SDTM domains** (e.g., DM, AE, EX, LB)
    ...
    -   Steps to create a datasets for each domain

        -   Create an empty shell (datasets)

        -   Map SDTM domain variables to the raw data

        -   Create a formats

        -   Derive the logic for variables that need calculating
