...
::: callout-note
[View code on GitHub](https://github.com/...) · [Project index](/projects/)
:::
...
| Population | District population | HMIS | Annual | 2016–2023 |
| Treatment-seeking (U5) | Public/private/no care | DHS/MIS | Every 3 years | 2014, 2017–18, 2021 |

### Data management

We applied a standard data quality workflow before analysis:
...
-   Detected and imputed outliers using **3σ**, **MAD**, and **IQR** rules.
...
Covariates (2016–2023): climate, ITN access/use, SMC coverage, stockouts (RDT/ACT/IPTp).\
