...
::: callout-note
**Key Insight:** Data quality varied substantially by district. Some districts had \>30% inactive facilities, strongly biasing crude incidence estimates.
:::
...
#### B. Sen's slope coefficient (Mann kendall test)
...
##### Normalize function : cette fonction permet de normaliser les diferents indicateurs afin de pouvoir leur comparer entre eux.
