...
![**Monthly reporting rates per health district**](images/weighted.png){fig-align="center" width="422"}
...
### 2. Malaria Incidence Trends

#### Sen's slope coefficient (Mann kendall test)

![**Fig. Sen's slope coefficient for malaria incidence**](images/Fichier5-02.png)

::: callout-note
**Key Insight:** Crude incidence suggested rising malaria burden, but after adjusting for testing, reporting, and treatment-seeking, trends stabilized post-2019.\
This highlights the risk of overestimating burden if raw HMIS data are used without correction.
:::
...
#### Normalize function : This function allows you to standardize the different indicators so that they can be compared with each other.
...
#### STL decomposition: This function allows you to decompose the time series, test significance, and estimate the slope coefficient.
