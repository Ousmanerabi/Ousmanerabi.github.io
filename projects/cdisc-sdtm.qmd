---
title: "End-to-end CDISC-SDTM Workflow (Mock Study)"
description: "From raw sources to SDTM using SAS (SAS OnDemand)."
format:
  html:
    toc: true
    toc-depth: 3
...
Cette page a pour objectif les principales étapes de la preparation des donnees brutes pour les donnees SDTM pretes. J'ai choisi de simplifier cette page afin de demontrer ma connaissance de la creation des donnees qui respectent le format SDTM.

:::{.callout-important}

A noter que le repertoire github xxx, j'ai utilisé des macro pour la creation, le formatage etc.. de ces domaines. Ces macros sont issus des livres que j'ai lu dans le cadre la preparation a la **Certification SAS Clinical Trials Programming**.
