---
title: "End-to-end CDISC-SDTM Workflow"
description: "From raw sources to SDTM using SAS."
format:
  html:
    toc: true
    toc-depth: 3
...
**Note:** In the corresponding GitHub repository, I used **SAS macros** to create, format, and validate the SDTM domains.\
