...
description: "Economic evaluation of a multidisciplinary pediatric obesity program in France using simulation modeling, cost-effectiveness analysis (ICER), and long-term efficiency estimation with discounted cost offsets."
author: "Ousmane Diallo"
date: "`r format(Sys.Date(), '%Y-%m-%d')`"
categories: [cost-effectiveness, ICER, linear regression, uncertainty analysis,
efficiency, HEOR]
...
1.  The **two-year growth rate (X)** in BMI *Z*-score was computed for each child from pre-inclusion data.\
...
This approach allowed comparing each child’s *observed* BMI Z-score trajectory (with REPPOP) to their *simulated* trajectory (no REPPOP). 
Note: This linear model assumes normality and linearity; sensitivity analyses (e.g., GAM) could address non-linearities.
...
# ============================================================================
# Counterfactual ZBMI at 2 years under "no REPPOP" scenario
# ============================================================================
...
# Positive value = improvement due to REPPOP intervention
...
Alternative methods (e.g., Fieller) could address ratio correlations.
...
where (N\_{\mathrm{obese,\;simulated}}) is the number of children classified as obese at 2 years in the no-intervention (counterfactual) simulation, and (N\_{\mathrm{obese,\;REPPOP}}) is the number observed after REPPOP care.
...
# ============================================================================
# Proportion of obesity cases prevented after 2 years of REPPOP
...
a0 <- mean(dat$age_inc1, na.rm = TRUE)  # Mean age at inclusion 8.2
...
|----------------------------|-------------------|------------ |
| Medical consultation       | 30                | Ameli/HAS   |
| Psychological consultation | 50                | Ameli/HAS   |
| Dietetic consultation      | 50                | Ameli/HAS   |
| Inclusion consultation     | 70                | Ameli/HAS   |
...
|----------------|----------------|----------------|------------------------|
| Benefits from age 18 to 60 | 2 % | 42 years | 4 512.3 |
|  | 4 % | 42 years | 3 752.1 |
| Benefits from age 40 to 60 | 2 % | 20 years | 1 372.5 |
|  | 4 % | 20 years | 761.8 |
...
::: {.striped .hover}
| Time Horizon | Start Age | End Age | Discount Rate | PV Avoided Cost (EUR) |
|:-------------|----------:|--------:|:--------------|----------------------:|
| 18–60 years  |        18 |      60 | 2%            |                4558.2 |
| 18–60 years  |        18 |      60 | 4%            |                2749.3 |
| 40–60 years  |        40 |      60 | 2%            |                1707.5 |
| 40–60 years  |        40 |      60 | 4%            |                 781.0 |
:::
