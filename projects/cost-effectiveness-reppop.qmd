...
After excluding children with missing data on social difficulties, those followed for more than 3.5 years, and those older than 12 years at inclusion, 354 children remained for analysis.
...
The REPPOP cohort included **354 children** (62.9% girls, sex ratio 1.7) with a mean age of **8.2 years (SD = 2.3)** and a mean age at onset of overweight of **2.7 years (SD = 1.6)**.
The mean baseline BMI Z-score was **3.34 years (SD = 0.97); 52.5%** of participants were classified as obese and **47.5%** as overweight.
...
![Fig: Cost-effectiveness (CE) plane showing the bootstrap distribution of incremental costs (ΔĈ) versus incremental effects (ΔÊ).](images/cost-effectiveness_bootstrap.png)
