...
where \(N_{\mathrm{obese,\;simulated}}\) is the number of children classified as obese at 2 years in the no-intervention (counterfactual) simulation, and \(N_{\mathrm{obese,\;REPOP}}\) is the number observed after REPOP care.
...
```{r}
#| label: fig-bootstrap
#| fig-cap: "Cost-effectiveness (CE) plane showing the bootstrap distribution of incremental costs (ΔĈ) versus incremental effects (ΔÊ)."
#| fig-align: center
#| out-width: 70%
