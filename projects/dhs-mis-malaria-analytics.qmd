...
*Note: Supporting files (lookup tables, helper functions) are available in the project's [GitHub repository](https://github.com/Ousmanerabi/Multi-Country-DHS_MIS_Data_Harmonization_for_Malaria_Analytics).*
...
#| eval: false
#| code-fold: true
#| code-summary: "Show code: Export analysis-ready dataset"
